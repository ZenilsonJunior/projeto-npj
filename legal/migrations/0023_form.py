    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nomeC', models.CharField(max_length=50)),
                ...
                ('EC', models.CharField(max_length=12, unique=True)),
                ('OE', models.CharField(max_length=12)),
                ...
                ('cpm', models.CharField(max_length=10)),
